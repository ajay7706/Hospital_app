...
const createProfessionalPDF = (doc, details, qrDataURL) => {
  ...
  doc.fillColor("#1e3a8a").fontSize(22).text("CL", 52, 55, { bold: true });

  // --- Brand Name ---
  doc.fillColor("#ffffff")
     .fontSize(22)
     .text(details.hospitalName || "Clinoza", 110, 48, { bold: true })
     .fontSize(9)
  ...
  currentY += 50;
  drawRow("OPD CONSULTATION FEE", `Rs. ${details.opdCharge || 0}`, 60, currentY);
  ...
  doc.fillColor("#1e3a8a").fontSize(9)
     .text(`Email: ${details.supportEmail || "support@clinoza.com"}`, 65, currentY + 32)
  ...
  doc.fillColor("#ffffff").fontSize(9)
     .text("Generated by Clinoza HealthCare Ecosystem - Secure Medical Records", 20, 753, { align: "center", width: 572 });
};
