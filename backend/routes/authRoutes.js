...
const { signup, login, createBranchStaff, getBranchStaff, forgotPasswordSendOTP, resetPassword } = require("../controllers/authController");
...
router.get("/branch-staff", protect, isHospital, getBranchStaff);
